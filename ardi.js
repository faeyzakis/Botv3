...
let qrovo = 'test';
/**List FF **/
let _diamond1 = '⦿ 50💎';     let diamond1 = 'Rp 8.000,00';
let _diamond2 = '⦿ 70💎';     let diamond2 = 'Rp 10.000,00';
let _diamond3 = '⦿ 100💎';     let diamond3 = 'Rp 14.000,00';
let _diamond4 = '⦿ 140💎';     let diamond4 = 'Rp 19.000,00';
let _diamond5 = '⦿ 210💎';   let diamond5 = 'Rp 28.000,00';
let _diamond6 = '⦿ 355💎';   let diamond6 = 'Rp 46.000,00';
let _diamond7 = '⦿ 400💎';   let diamond7 = 'Rp 53.000,00';
let _diamond8 = '⦿ 500💎';   let diamond8 = 'Rp 70.000,00';
let _diamond9 = '⦿ 720💎';   let diamond9 = 'Rp 92.000,00'; 
let _diamond10 = '⦿ 1000💎'; let diamond10 = 'Rp 130.000,00';
let _diamond11 = '⦿ 1075💎';      let diamond11 = 'Rp 136.000,00';
let _diamond12 = '💳 M.MINGGUAN';         let diamond12 = 'Rp 28.000,00';
let _diamond13 = '💳 M.BULANAN';         let diamond13 = 'Rp 137.000,00';
//--------------------------------//
///dmmlsini
...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Faeyza_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6285855159230-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IlpQRKWDZed0GgVHmYJUbl', "groupName": `${NamaBot}`, "footerText": "*_© Faeyza_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const daftar2 = '```Ketik Tombol Di Bawah Untuk Verify Ke Database Faeyza```'
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Faeyza_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Faeyza_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© Faeyza_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = '🌹Faeyza🌹'
       ownerJid = "628994568974@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `╭─❒ 「 Bot Info 」 ❒
├ _Creator : wa.me/628994568974
├ _Battery : ${baterai.battery}_
├ _Mode : ${publik ? 'Public' : 'Self'}_
├ _Total Hit : ${cmhit.length}_
├ _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
 ...
 rows: [
                          {
                           ...
                           {
                              "title": "100💎 = IDR 14.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           },
                           {
                              "title": "140💎 = IDR 19.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           },
                           {
                              "title": "210💎 = IDR 28.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           },
                           {
                              "title": "355💎 = IDR 46.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           },
                           {
                              "title": "400💎 IDR 53.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           },
                           {
                           ...
                           {
                              "title": "720💎 IDR 92.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           },
                           {
                              "title": "1000💎 IDR 130.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           },
                           {
                              "title": "1075💎 IDR 136.000 \n\n _Created By Faeyza_",
                              "rowId": ""
                           }
                        ]
                     }],
...
case 'proses' :
case 'p' :
reply('STATUS ORDERAN : SEDANG DI PROSES \n\n INFO : MOHON DI TUNGGU 1 - 5 menit')
break
case 'done bwang' :
case 'd' :
reply('STATUS ORDERAN : BERHASIL \n\n INFO : ORDERAN TELAH SUKSES DI KIRIM, SILAHKAN DI CEK \n APABILA BELUM MASUK RELOG GAME KAMU')
break
case 'maker': case 'maker2': 
case 'maker3': case 'maker4':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
  sticWait(from)
if (args.length < 1) return reply(`*Example :*\n${prefix + command} Faeyza`)
...
client.browserDescription = ['Faeyza','Desktop','3.0']
